	...
	<div class="container">
		...
		<div class="header">
			<div class="logo-section">
				<img src="{{ public_path('gambar/logo.png') }}" alt="Logo DD Knalpot Racing">
			</div>
		...
		<div class="content">
			...
			<div class="info-section">
				<div class="info-group">
					<div class="info-row">
						...
						<span class="info-value">: #{{ str_pad($pembelian->id, 6, '0', STR_PAD_LEFT) }}</span>
					</div>
					<div class="info-row">
				...
				<div class="info-group">
					<div class="info-row">
						...
						<span class="info-value">: {{ \Carbon\Carbon::parse($pembelian->tanggal_masuk)->format('d-m-Y') }}</span>
					</div>
					<div class="info-row">
			...
			<table class="items-table">
				...
				<tbody>
					<tr>
						...
						<td class="text-center">{{ $pembelian->ukuran }}</td>
						<td class="text-right">{{ number_format($pembelian->jumlah, 0, ',', '.') }}</td>
						<td class="text-right">Rp {{ number_format($pembelian->harga, 0, ',', '.') }}</td>
						<td class="text-right"><strong>Rp {{ number_format($pembelian->harga * $pembelian->jumlah, 0, ',', '.') }}</strong></td>
					</tr>
				</tbody>
			</table>
			...
			<div class="total-section">
				<div class="total-box">
					<div class="total-row">
						...
						<span class="total-value">Rp {{ number_format($pembelian->harga * $pembelian->jumlah, 0, ',', '.') }}</span>
					</div>
					<div class="total-row">
			...
			<div class="notes-section">
				...
				<div class="notes-text">
					Barang yang dibeli dapat ditukar atau dikembalikan jika ada cacat dari pabrik sesuai dengan kondisi. Pembayaran harus dilunasi sebelum barang dibawa keluar. Terima kasih atas kerja sama dengan DD Knalpot Racing.
				</div>
			</div>
		...
		<!-- Footer -->
		<div class="footer">
			<p><strong>DD Knalpot Racing</strong> | Dicetak: {{ now()->format('d-m-Y H:i:s') }} | Halaman Nota Pembelian</p>
		</div>
	</div>
</body>
