...
<body>
	<div class="container">
			...
			<div class="info-section">
				<div class="info-group">
					<div class="info-row">
						...
						<span class="info-value">: #{{ str_pad($penjualan->id, 6, '0', STR_PAD_LEFT) }}</span>
					</div>
					<div class="info-row">
				...
				<div class="info-group">
					<div class="info-row">
						...
						<span class="info-value">: {{ \Carbon\Carbon::parse($penjualan->tanggal_masuk)->format('d-m-Y') }}</span>
					</div>
					<div class="info-row">
			...
			<table class="items-table">
				...
				<tbody>
					<tr>
						...
						<td class="text-center">{{ $penjualan->ukuran }}</td>
						<td class="text-right">{{ number_format($penjualan->jumlah, 0, ',', '.') }}</td>
						<td class="text-right">Rp {{ number_format($penjualan->harga, 0, ',', '.') }}</td>
						<td class="text-right"><strong>Rp {{ number_format($penjualan->harga * $penjualan->jumlah, 0, ',', '.') }}</strong></td>
					</tr>
				</tbody>
			</table>
			...
			<div class="total-section">
				<div class="total-box">
					<div class="total-row">
						...
						<span class="total-value">Rp {{ number_format($penjualan->harga * $penjualan->jumlah, 0, ',', '.') }}</span>
					</div>
					<div class="total-row">
		...
		<!-- Footer -->
		<div class="footer">
			<p><strong>DD Knalpot Racing</strong> | Dicetak: {{ now()->format('d-m-Y H:i:s') }} | Halaman Nota Penjualan</p>
		</div>
	</div>
</body>
