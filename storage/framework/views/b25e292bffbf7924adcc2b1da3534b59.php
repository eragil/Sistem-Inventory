<div class="dashboard-container">
    ...
    <div class="welcome-section mb-4">
        <h1 class="welcome-title">Selamat Datang, <?php echo e(Auth::user()->name); ?>! 👋</h1>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="kpi-card kpi-barang">
                ...
                <div class="kpi-content">
                    ...
                    <h3 class="kpi-value"><?php echo e(number_format($totalBarang)); ?></h3>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="kpi-card kpi-penjualan">
                ...
                <div class="kpi-content">
                    ...
                    <h3 class="kpi-value"><?php echo e($totalPenjualan); ?></h3>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="kpi-card kpi-pembelian">
                ...
                <div class="kpi-content">
                    ...
                    <h3 class="kpi-value"><?php echo e($totalPembelian); ?></h3>
                    <small class="kpi-subtitle">Transaksi</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="kpi-card kpi-keluar">
                ...
                <div class="kpi-content">
                    ...
                    <h3 class="kpi-value"><?php echo e($totalBarangKeluar); ?></h3>
                    <small class="kpi-subtitle">Transaksi</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card revenue-card revenue-income">
                <div class="card-body">
                    ...
                    <p class="revenue-value">Rp <?php echo e(number_format($pendapatanBulanIni, 0, ',', '.')); ?></p>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="card revenue-card revenue-expense">
                <div class="card-body">
                    ...
                    <p class="revenue-value">Rp <?php echo e(number_format($pengeluaranBulanIni, 0, ',', '.')); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<!-- Chart Data Storage -->
<div id="chartData" data-penjualan="<?php echo e($chartDataPenjualan); ?>" data-pembelian="<?php echo e($chartDataPembelian); ?>" style="display:none;"></div>
...
<?php /**PATH C:\xampp\htdocs\Inventory dan Penjualan\resources\views/livewire/dashboard.blade.php ENDPATH**/ ?>