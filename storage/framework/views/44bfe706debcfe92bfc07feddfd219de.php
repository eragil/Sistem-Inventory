				...
				<td><?php echo e($barang->tanggal_masuk); ?></td>
					...
					<td>
						<div class="d-flex gap-2">
							<a href="<?php echo e(route('nota-penjualan', $barang->id)); ?>" class="btn btn-sm btn-info" target="_blank">
								<i class="fas fa-file-pdf"></i> Cetak Nota
							</a>
							<button class="btn btn-sm btn-warning" wire:click='edit(<?php echo e($barang->id); ?>)'>Edit</button>
							<button class="btn btn-sm btn-danger" wire:click='hapus(<?php echo e($barang->id); ?>)'
...
<?php /**PATH C:\xampp\htdocs\Inventory dan Penjualan\resources\views/livewire/penjualan.blade.php ENDPATH**/ ?>